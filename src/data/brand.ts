...
export const brand = {
	...
	copy: {
		...
		heroLede: 'Undetected hero ESP, aimbot, and cooldown tracker for Marvel Rivals on Windows PC.',
		...
		previewIntro:
			'{brand} for {game} — hero ESP, aimbot, cooldown tracker, and {antiCheat} rebuilds after patches.',
		setupIntro: 'Install {brand} on Windows PC after you buy. Follow these short steps.',
		supportIntro: 'Need help with {brand}? Email {email} with your order ID.',
		faqIntro: 'Short answers about delivery, setup, updates, and refunds.',
		reviewsIntro: 'Feedback from {brand} buyers — hero ESP, aimbot, cooldowns, and support.',
		chipEsp: 'Hero ESP',
		chipAim: 'Aimbot',
