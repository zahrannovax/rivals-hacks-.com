...
const copyDefaults = {
	...
	statusIntro: 'Check {brand} status after a {game} or {antiCheat} patch before you play.',
	previewIntro: 'A quick look at {brand} — undetected ESP, aimbot, and updates after patches.',
	...
	reviewsIntro: 'Buyer feedback from {brand} — ESP, aimbot, cooldowns, and support.',
...
export const productInfo = {
	...
	features: {
		...
		radar: ['Ability cooldown tracker', 'Stream-proof mode', 'Cloud-DMA option', 'AWS option'],
		general: [
			fillBrandTokens('{antiCheat} anti-cheat bypass after patches'),
			'24/7 support',
