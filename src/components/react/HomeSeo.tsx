	...
	const categories = [
		{
			...
			links: [
				...
				{ href: '/marvel-rivals-cooldown-tracker/', labelKey: 'homeSeo.linkRadar' },
			],
		},
		{
			...
			links: [
				...
				{ href: '/marvel-rivals-cheats/', labelKey: 'homeSeo.linkUndetected' },
		...
		},
		{
			...
			links: [
				...
				{ href: '/marvel-rivals-cheats/', labelKey: 'homeSeo.linkTarkovCheats' },
				{ href: '/features/', labelKey: 'homeSeo.linkAllFeatures' },
			],
		},
		{
