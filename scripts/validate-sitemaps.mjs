...
const ENGLISH_PATHS = [
	...
	'/blog/health-and-shield-bars/',
	'/blog/team-composition-esp/',
	'/blog/objective-marker-esp/',
	'/blog/no-recoil-system/',
	'/blog/fov-customization/',
	'/blog/aim-smoothing-controls/',
	...
	'/reviews/marvel-rivals-aim-smoothing-review-ctrl-player99/',
	'/reviews/marvel-rivals-setup-review-stormchaser07/',
	'/reviews/marvel-rivals-ultimate-esp-review-ulttrackx/',
	'/reviews/marvel-rivals-aimbot-ranked-review-rankedgrind42/',
	'/reviews/marvel-rivals-objective-esp-review-objholdmr/',
	'/reviews/marvel-rivals-nace-update-review-patchdaymike/',
	'/reviews/marvel-rivals-hitscan-aimbot-review-snipezonly/',
	'/faq/what-are-marvel-rivals-cheats/',
	'/faq/are-marvel-rivals-cheats-undetected-in-2026/',
	'/faq/duelist-vanguard-strategist-support/',
	'/faq/esp-aimbot-or-cooldown-tracker/',
	'/faq/how-are-licenses-delivered/',
	'/faq/where-to-check-updates/',
	'/faq/how-to-contact-support/',
	'/faq/what-is-a-marvel-rivals-wallhack/',
	'/faq/does-marvel-rivals-cheats-include-cooldown-tracker/',
	'/faq/nace-anti-cheat-and-marvel-rivals-cheats/',
